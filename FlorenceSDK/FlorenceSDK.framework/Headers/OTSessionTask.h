...
@property (nonatomic, copy) NSString * _Nullable authName;
@property (nonatomic, copy) NSString * _Nullable authPassword;

#define kKeyUserDefaults_TimeOut        @"InterDigital_UserDefaultsTrace"
 ...
 *
 * @param authName The user name or nil
 * @param authPassword The user password or nil
 */
- (void)setAuthName:(NSString * _Nullable)authName authPassword:(NSString * _Nullable)authPassword;
