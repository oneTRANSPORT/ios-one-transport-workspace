...
/*
 ...
 This activates the NSLog and the postNotifications through kKeyNotification_Trace. For an example, see ViewControllerBase.m
    viewWillAppear
    viewWillDisappear
 */
 ...
 */
typedef NS_OPTIONS(NSInteger, CommandType) {
    CommandTypeCreate,
    CommandTypeDiscover,
 ...
 */
typedef NS_OPTIONS(NSInteger, SubCommandType) {
    SubCommandTypeNone,
 ...
 */
typedef NS_OPTIONS(NSInteger, CommunicationsProgress) {
 ...
 */
typedef NS_OPTIONS(NSInteger, ResourceType) {
 ...
 */
typedef NS_OPTIONS(NSInteger, StatusCode) {
    StatusCodeNotSet = 0,
 ...
 */
typedef NS_OPTIONS(NSInteger, AccessControlOperation) {
 ...
 * OneM2M
 */
typedef NS_OPTIONS(NSInteger, ConsistencyStrategy) {
 ...
 * OneM2M
 */
typedef NS_OPTIONS(NSInteger, PendingNotification) {
 ...
 * OneM2M
 */
typedef NS_OPTIONS(NSInteger, NotificationContentType) {
 ...
 * OneM2M
 */
typedef NS_OPTIONS(NSInteger, NotificationEventType) {
 ...
 * OneM2M
 */
typedef NS_OPTIONS(NSInteger, LocationSource) {
 ...
 * Used by unit tests
 */
typedef NS_OPTIONS(NSInteger, CommsStatus) {
